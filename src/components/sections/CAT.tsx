          ...
          <div className="grid gap-12 lg:grid-cols-3">
            {steps.map((step) => {
              ...
              return (
                ...
                >
                  <div className="z-10 flex h-56 w-56 items-center justify-center rounded-full border-[6px] border-[#2B7FD3] bg-white shadow-lg">
                    ...
                    <div>
                      ...
                      <p className="mt-4 px-6 text-lg text-gray-700">
                        {step.description}
                      </p>
